...
class CMB2_Options_Hookup extends CMB2_Hookup {
	...
	public function hooks() {
		...
		register_setting( 'wp-digital-italia', $this->option_key );
	...
	public function maybe_register_message() {
		...
		$code            = '';
		$message         = __( 'Nothing to update.', 'wp-digital-italia' );
		$type            = 'notice-warning';

		if ( $is_updated ) {
			$message = __( 'Settings updated.', 'wp-digital-italia' );
			$type    = 'updated';
		}
