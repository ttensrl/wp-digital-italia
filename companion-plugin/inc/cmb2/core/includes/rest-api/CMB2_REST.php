 ...
 * @link      https://cmb2.io
 *
 * @property-read string[] $read_fields Array of readable field IDs.
 * @property-read string[] $edit_fields Array of editable field IDs.
...
class CMB2_REST extends CMB2_Hookup_Base {
	...
	protected static function register_rest_field( $object_types, $object_type ) {
		register_rest_field( $object_types, 'wp-digital-italia', array(
	...
	public static function get_post_rest_values( $object, $field_name, $request, $object_type ) {
		if ( 'wp-digital-italia' === $field_name ) {
