...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'wp-digital-italia' ),
			'defaultString' => esc_html__( 'Default', 'wp-digital-italia' ),
			'pick'          => esc_html__( 'Select Color', 'wp-digital-italia' ),
			'current'       => esc_html__( 'Current Color', 'wp-digital-italia' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'wp-digital-italia' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'wp-digital-italia' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'wp-digital-italia' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'wp-digital-italia' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'wp-digital-italia' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'wp-digital-italia' ) ),
					'nextText'        => esc_html__( 'Next', 'wp-digital-italia' ),
					'prevText'        => esc_html__( 'Prev', 'wp-digital-italia' ),
					'currentText'     => esc_html__( 'Today', 'wp-digital-italia' ),
					'closeText'       => esc_html__( 'Done', 'wp-digital-italia' ),
					'clearText'       => esc_html__( 'Clear', 'wp-digital-italia' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'wp-digital-italia' ),
					'timeText'      => esc_html__( 'Time', 'wp-digital-italia' ),
					'hourText'      => esc_html__( 'Hour', 'wp-digital-italia' ),
					'minuteText'    => esc_html__( 'Minute', 'wp-digital-italia' ),
					'secondText'    => esc_html__( 'Second', 'wp-digital-italia' ),
					'currentText'   => esc_html__( 'Now', 'wp-digital-italia' ),
					'closeText'     => esc_html__( 'Done', 'wp-digital-italia' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'wp-digital-italia' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'wp-digital-italia' ),
				'upload_files' => esc_html__( 'Use these files', 'wp-digital-italia' ),
				'remove_image' => esc_html__( 'Remove Image', 'wp-digital-italia' ),
				'remove_file'  => esc_html__( 'Remove', 'wp-digital-italia' ),
				'file'         => esc_html__( 'File:', 'wp-digital-italia' ),
				'download'     => esc_html__( 'Download', 'wp-digital-italia' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'wp-digital-italia' ),
			),
		);
