...
function cmb2_attached_posts_field_metaboxes_example() {
	...
	$example_meta = new_cmb2_box( array(
		...
		'title'        => __( 'Attached Posts', 'wp-digital-italia' ),
	...
	$example_meta->add_field( array(
		'name'    => __( 'Attached Posts', 'wp-digital-italia' ),
		'desc'    => __( 'Drag posts from the left column to the right column to attach them to this page.<br />You may rearrange the order of the posts in the right column by dragging and dropping.', 'wp-digital-italia' ),
	...
	$example_meta->add_field( array(
		'name'    => __( 'Attached Users', 'wp-digital-italia' ),
		'desc'    => __( 'Drag users from the left column to the right column to attach them to this page.<br />You may rearrange the order of the users in the right column by dragging and dropping.', 'wp-digital-italia' ),
