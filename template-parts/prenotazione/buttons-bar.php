<div class="cmp-nav-steps">
    <nav class="steppers-nav" aria-label="Step">
        ...
        <button
        type="button"
        class="btn btn-outline-primary bg-white btn-sm steppers-btn-save d-none saveBtn"
        ...
        <button
        type="button"
        class="btn btn-outline-primary bg-white btn-sm steppers-btn-save d-none saveBtn center"
        style="display: none !important;"
        >
