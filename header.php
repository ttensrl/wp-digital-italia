                                        ...
                                        <div class="it-socials d-none d-md-flex">
                                            ...
                                            <ul>
                                                ...
                                                if (!empty($facebook_url)) {
                                                    echo '<li class="ms-3"><a href="' . esc_url($facebook_url) . '" aria-label="Facebook" target="_blank"><svg class="icon ms-0"><use href="' . esc_url(get_template_directory_uri()) . '/dist/images/sprites.svg#it-facebook"></use></svg></a></li>';
                                                }

                                                // Twitter
                                                if (!empty($twitter_url)) {
                                                    echo '<li class="ms-3"><a href="' . esc_url($twitter_url) . '" aria-label="Twitter" target="_blank"><svg class="icon ms-0"><use href="' . esc_url(get_template_directory_uri()) . '/dist/images/sprites.svg#it-twitter"></use></svg></a></li>';
                                                }

                                                // Instagram
                                                if (!empty($instagram_url)) {
                                                    echo '<li class="ms-3"><a href="' . esc_url($instagram_url) . '" aria-label="Instagram" target="_blank"><svg class="icon ms-0"><use href="' . esc_url(get_template_directory_uri()) . '/dist/images/sprites.svg#it-instagram"></use></svg></a></li>';
                                                }
                                                ?>
                                            </ul>
                                        </div>
